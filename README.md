...
[![Python](https://img.shields.io/badge/Python-3.14-3776AB?logo=python&logoColor=white)](https://docs.python.org/3/)
...
[![CuPy](https://img.shields.io/badge/CuPy-14.2-4B8BBE?logo=python&logoColor=white)](https://docs.cupy.dev/en/stable/)
...
Version badges describe repository dependency floors. Python 3.14 is the only
supported interpreter on every host; CUDA-Q 0.16 pairs it with CuPy 14.x.
CUDA-QX is a planned extension.
...
| Current runtime | Same GPU model; driver 616.92, CUDA runtime 13020 (CuPy 14.2.0), CUDA-Q 0.16.0.post1 on `nvidia`, Python 3.14.7 in WSL2, verified 2026-09-23 |
